...
protected void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    boolean status = request.getParameter("status") != null; // Define o status como true se o parâmetro estiver presente

    ECliente cliente = new ECliente();
    cliente.setCodigo(Integer.parseInt(codigo));
    cliente.setNome(nome);
    cliente.setDatanascimento(Date.valueOf(datanascimento));
    cliente.setStatus(status); // Define o status conforme verificação acima
